...
function isiRow(value) {
    let content = isiTabel
      ...
      .replace('#TANGGAL#', value.presensi.nama_mk.tanggal ? value.presensi.nama_mk.tanggal : '#TANGGAL#')
      .replace('#CHECKIN#', value.presensi.nama_mk.checkin ? value.presensi.nama_mk.checkin : '#CHECKIN#')
